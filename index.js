...
function randomQuote(inspQuote, philQuote, funFact) {
  ...
  inspQuote = ["Be yourself; everyone else is already taken - Oscar Wilde", "It is during our darkest moments that we must focus to see the light - Aristotle",
      "If opportunity doesn't knock, build a door -Milton Berle", 
      "Perfection is not attainable, but if we chase perfection we can catch excellence -Vince Lombardi",
      "A champion is someone who gets up when he can't -Jack Dempsey",
      "It is never too late to be what you might have been -George Eliot"]
  philQuote = ["Most people are other people. Their thoughts are someone else's opinions, their lives a mimicry, their passions a quotation -Oscar Wilde",
  ...
  funFact = ["Tigers have striped skin", "Octopi have three hearts", "Earth's rotation is slowing down",
